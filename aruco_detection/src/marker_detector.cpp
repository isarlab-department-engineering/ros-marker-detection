...
int main(int argc, char **argv)
{
  ...
  string CAM_TOPIC;
  n.param<string>("/marker_detection/cameraTopic", CAM_TOPIC, "undefined_subscribed_topic_name");
  ...
  cameraMatrix = (Mat_<double>(3,3) <<  n.param("/marker_detection/cameraMatrix11", 0.), n.param("/marker_detection/cameraMatrix12", 0.), n.param("/marker_detection/cameraMatrix13", 0.),
                                        n.param("/marker_detection/cameraMatrix21", 0.), n.param("/marker_detection/cameraMatrix22", 0.), n.param("/marker_detection/cameraMatrix23", 0.),
                                        n.param("/marker_detection/cameraMatrix31", 0.), n.param("/marker_detection/cameraMatrix32", 0.), n.param("/marker_detection/cameraMatrix33", 0.));   
  distCoeffs   = (Mat_<double>(1,5) <<  n.param("/marker_detection/distCoeffs11", 0.), n.param("/marker_detection/distCoeffs21", 0.), n.param("/marker_detection/distCoeffs31", 0.), n.param("/marker_detection/distCoeffs41", 0.), n.param("/marker_detection/distCoeffs51", 0.));

  // SUBSCRIBER
  ros::Subscriber sub = n.subscribe(CAM_TOPIC.c_str(), 0, webcamCallback);
  // PUBLISHER
  pub = n.advertise<marker_detection::ArMarkers>("markers_stream", 0);
